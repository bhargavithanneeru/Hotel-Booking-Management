...
const AuthReducer = (state, action) => {
  switch (action.type) {
    case "LOGIN_START":
    case "REGISTER_START": // Add registration start action
      return {
        user: null,
        loading: true,
        error: null,
    ...
    case "LOGIN_SUCCESS":
    case "REGISTER_SUCCESS": // Add registration success action
      return {
        user: action.payload,
        loading: false,
        error: null,
    ...
    case "LOGIN_FAILURE":
    case "REGISTER_FAILURE": // Add registration failure action
      return {
        user: null,
        loading: false,
